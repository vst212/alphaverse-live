...
//** Recovery Pot1: 320*0.7 = 224 TRX  3000*0.7 = 2100 TRX                                  **
//** Bust Threshold: 20.5 TRX                                                               **
//** Max Loss Streak: -20.5 TRX                                                             **
//**                                                                                        **
//** Details:                                                                               **
...
async function doBet() {
    ...
    if (win) {
        ...
        if (Math.abs(currentStreak) >= 1 && Math.abs(currentStreak) <= 21) {
            nextBet = previousBet * 2.2;
        } else if (Math.abs(currentStreak) >= 23) {
            nextBet = previousBet * 2.0527;
        } else {
            nextBet = previousBet * 2.0527;
        }
        bankerBet = nextBet;
